...
class Utilities {
 public:
        ...
        std::set<int> GetNumberRange(int begin, int end);
        int ToInteger(char _chr);
        int ToAscii(int _inp);
        bool SetContainsSet(std::set<int> set1,  std::set<int> set2);
        bool DoSetsHaveOverlapItems(std::set<int> set1, std::set<int> set2);
